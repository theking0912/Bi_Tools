...
from PyQt5.QtWidgets import QWidget, QLabel, QPushButton, QLineEdit, QPlainTextEdit, QHBoxLayout, QVBoxLayout, \
    ...
    def write_to_excel(self,pdf_todo_dir,excel_dir,key_word,results):
        ...
        for item in results:
            try:
                ...
                worksheet.write_string(row, col, key_word0)
                worksheet.write_string(row, col + 1, key_word1)
                worksheet.write_string(row, col + 2, key_word2)
                worksheet.write_string(row, col + 3, key_word3)
                worksheet.write_string(row, col + 4, key_word4)
                worksheet.write_string(row, col + 5, key_word5)
                worksheet.write_string(row, col + 6, key_word6)
                worksheet.write_string(row, col + 7, key_word7)
                worksheet.write_string(row, col + 8, key_word8)
                worksheet.write_string(row, col + 9, key_word9)
                worksheet.write_string(row, col + 10, key_word10)
                worksheet.write_string(row, col + 11, key_word11)
                worksheet.write_string(row, col + 12, key_word12)
                worksheet.write_string(row, col + 13, key_word13)
                worksheet.write_string(row, col + 14, key_word14)
                worksheet.write_string(row, col + 15, key_word15)
                worksheet.write_string(row, col + 16, key_word16)
                worksheet.write_string(row, col + 17, key_word17)
                worksheet.write_string(row, col + 18, key_word18)
                worksheet.write_string(row, col + 19, key_word19)
                worksheet.write_string(row, col + 20, key_word20)
                worksheet.write_string(row, col + 21, key_word21)
                worksheet.write_string(row, col + 22, key_word22)
                worksheet.write_string(row, col + 23, key_word23)
                worksheet.write_string(row, col + 24, key_word24)
                worksheet.write_string(row, col + 25, key_word25)
                worksheet.write_string(row, col + 26, key_word26)
                worksheet.write_string(row, col + 27, key_word27)
                worksheet.write_string(row, col + 28, key_word28)
                worksheet.write_string(row, col + 29, key_word29)
                worksheet.write_string(row, col + 30, key_word30)
            except Exception:
